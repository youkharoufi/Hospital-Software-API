...
namespace Hospital_Software.Data.Seeds
{
    public static class DbSeeder
    {
                ...
                var users = new List<(ApplicationUser user, string password)>
        {
            ...
            (new ApplicationUser { UserName = "Kakashi", Firstname = "Kakashi", Lastname = "Hatake", BadgeNumber = 1673, RoleName = "Doctor", PictureUrl=$"{uri}images/Kakashi.png", Speciality="Traumatology" }, "Password123!"),
            (new ApplicationUser { UserName = "Annie", Firstname = "Annie", Lastname = "Leonhart", BadgeNumber = 8945, RoleName = "Doctor", PictureUrl=$"{uri}images/annie.png", Speciality="Pediatric" }, "Password123!"),
            (new ApplicationUser { UserName = "Mikasa", Firstname = "Mikasa", Lastname = "Ackerman", BadgeNumber = 8765, RoleName = "Doctor", PictureUrl=$"{uri}images/mikasa.png", Speciality="Pediatric" }, "Password123!"),
            (new ApplicationUser { UserName = "Armin", Firstname = "Armin", Lastname = "Van Burren", BadgeNumber = 1256, RoleName = "Doctor", PictureUrl=$"{uri}images/armin.png", Speciality="Dental" }, "Password123!"),
